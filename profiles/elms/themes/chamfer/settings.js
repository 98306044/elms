...
//toggle footer links
  ...
  //initialize colors
  $("#edit-chamfer-color-primary,#edit-chamfer-color-secondary,#edit-chamfer-color-header1,#edit-chamfer-color-header2,#edit-chamfer-color-text,#edit-chamfer-color-link,#edit-chamfer-color-blocks,#edit-chamfer-color-footer-text,#edit-chamfer-color-footer-links").keyup();
});
