$(document).ready(function(){
  ...
  $('#regions_elms_nav_left .regions_toggle').addClass('regions_toggle_closed');
  ...
  $('#regions_elms_nav_left .regions_block_title').click(function(){
	...
	if ($('#regions_elms_nav_left .regions_toggle').hasClass('regions_toggle_closed')) {
	  $('#regions_elms_nav_left .regions_toggle').addClass('regions_toggle_open');
	  $('#regions_elms_nav_left .regions_toggle').removeClass('regions_toggle_closed');
